...
class VectorQuantizer2(nn.Module):
    ...
    def forward(self, z, temp=None, rescale_logits=False, return_logits=False):
        ...
        return (
            ...
            loss,
            perplexity,
            min_encoding_indices.view(z.shape[0], z.shape[1]),
        )
...
class Embedding(nn.Module):
    def __init__(self, query_channel=3, latent_channel=192):
        ...
        self.l4 = weight_norm(
            nn.Linear(512, 512 - query_channel - latent_channel)
        )
...
class Embedding(nn.Module):
    def __init__(self, query_channel=3, latent_channel=192):
        ...
        self.l4 = weight_norm(
            nn.Linear(
                512, 512 - query_channel - latent_channel - self.embedding_dim
            )
        )
        self.l5 = weight_norm(nn.Linear(512, 512))
        self.l6 = weight_norm(nn.Linear(512, 512))
